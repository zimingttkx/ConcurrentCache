...
| 2026-05-09 | V3.1 RDB持久化 | ✅ 新增 | RDB快照持久化 + 自动保存调度器 |
...
│   │
│   ├── cache/
│   │   └── storage.h/cpp      ✅ 全局存储（V3 适配 CacheObject）
│   │
│   └── persistence/
│       ├── rdb.h/cpp           ✅ V3.1 RDB 持久化
│       └── rdb_scheduler.h/cpp ✅ V3.1 RDB 调度器
│
├── test/
│   ├── trace/                      ✅ 测试框架
│   ├── lock_test/                  ✅ 锁测试
